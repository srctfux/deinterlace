...
BOOL ProcessAspectRatioSelection(HWND hWnd, WORD wMenuID)
{
	...
	case IDM_WINPOS_VERT_BOTTOM:
		aspectSettings.VerticalPos = wMenuID - IDM_WINPOS_VERT_BOTTOM; 
		WorkoutOverlaySize();
		break;
	...
	case IDM_WINPOS_HORZ_RIGHT:
		aspectSettings.HorizontalPos = wMenuID - IDM_WINPOS_HORZ_RIGHT; 
		WorkoutOverlaySize();
		break;
...
{
	aspectSettings.HorizontalPos = NewValue;
	WorkoutOverlaySize();
	return FALSE;
}
...
{
	aspectSettings.VerticalPos = NewValue;
	WorkoutOverlaySize();
	return FALSE;
}
...
{
	{
		"Overscan", SLIDER, 0, &aspectSettings.InitialOverscan,
		DEFAULT_OVERSCAN_NTSC, 0, 150, 1, 1,
		NULL,
		"Hardware", "InitialOverscan", Aspect_Overscan_OnChange,
	},
	{
		"Source Aspect", NUMBER, 0, &aspectSettings.source_aspect,
		1333, 1000, 3000, 1, 1000,
		NULL,
		"ASPECT", "SourceAspect", SourceAspect_OnChange,
	},
	{
		"Custom Source Aspect", SLIDER, 0, &aspectSettings.custom_source_aspect,
		1335, 1000, 3000, 5, 1000,
		NULL,
		"ASPECT", "CustomSourceAspect", CustomSourceAspect_OnChange,
	},
	{
		"Screen Aspect", NUMBER, 0, &aspectSettings.target_aspect,
		1333, 0, 3000, 1, 1000,
		NULL,
		"ASPECT", "TargetAspect", TargetAspect_OnChange,
	},
	{
		"Custom Screen Aspect", SLIDER, 0, &aspectSettings.custom_target_aspect,
		1335, 1000, 3000, 5, 1000,
		NULL,
		"ASPECT", "CustomTargetAspect", CustomTargetAspect_OnChange,
	},
	{
		"Aspect Mode", NUMBER, 0, &aspectSettings.aspect_mode,
		1, 0, 2, 1, 1,
		NULL,
		"ASPECT", "Mode", AspectMode_OnChange,
	},
	{
		"Auto Detect Aspect Sensitivity", SLIDER, 0, &aspectSettings.LuminanceThreshold,
		30, 0, 127, 1, 1,
		NULL,
	...
	{
		"Auto Detect Aspect", ONOFF, 0, &aspectSettings.AutoDetectAspect,
		FALSE, 0, 1, 1, 1,
		NULL,
		"ASPECT", "AutoDetectAspect", NULL,
	},
	{
		"Zoom In Frame Count", SLIDER, 0, &aspectSettings.ZoomInFrameCount,
		60, 0, 1000, 10, 1,
		NULL,
		"ASPECT", "ZoomInFrameCount", NULL,
	},
	{
		"Aspect History Time", SLIDER, 0, &aspectSettings.AspectHistoryTime,
		300, 0, 3000, 10, 1,
		NULL,
		"ASPECT", "AspectHistoryTime", NULL,
	},
	{
		"AspectConsistencyTime", SLIDER, 0, &aspectSettings.AspectConsistencyTime,
		15, 0, 300, 5, 1,
		NULL,
		"ASPECT", "AspectConsistencyTime", NULL,
	},
	{
		"Vert Image Pos", ITEMFROMLIST, 0, &aspectSettings.VerticalPos,
		VERT_POS_CENTRE, 0, 2, 1, 1,
		VertPosString,
		"ASPECT", "VerticalPos", VertPos_OnChange,
	},
	{
		"Horiz Image Pos", ITEMFROMLIST, 0, &aspectSettings.HorizontalPos,
		HORZ_POS_CENTRE, 0, 2, 1, 1,
		HorzPosString,
		"ASPECT", "HorizontalPos", HorizPos_OnChange,
	},
	{
		"Clipping", ONOFF, 0, &aspectSettings.aspectImageClipped,
		TRUE, 0, 1, 1, 1,
		NULL,
		"ASPECT", "Clipping", NULL,
	},
	{
		"Bounce", ONOFF, 0, &aspectSettings.bounceEnabled,
		FALSE, 0, 1, 1, 1,
		NULL,
		"ASPECT", "Bounce", Bounce_OnChange,
	},
	{
		"Bounce Period", NUMBER, 0, &aspectSettings.bouncePeriod,
		60*30, 0, 2, 1, 1,
		NULL,
	...
	{
		"Bounce Timer Period (ms)", NUMBER, 0, &aspectSettings.timerBounceMS,
		1000, 0, 2, 1, 1,
		NULL,
		"ASPECT", "BounceTimerPeriod", NULL,
	},
	{
		"Orbit", ONOFF, 0, &aspectSettings.orbitEnabled,
		FALSE, 0, 1, 1, 1,
		NULL,
		"ASPECT", "Orbit", Orbit_OnChange,
	},
	{
		"Orbit Period X", NUMBER, 0, &aspectSettings.orbitPeriodX,
		60*45, 0, 2, 1, 1,
		NULL,
		"ASPECT", "OrbitPeriodX", NULL,
	},
	{
		"Orbit Period Y", NUMBER, 0, &aspectSettings.orbitPeriodY,
		60*60, 0, 2, 1, 1,
		NULL,
		"ASPECT", "OrbitPeriodY", NULL,
	},
	{
		"Orbit Size", NUMBER, 0, &aspectSettings.orbitSize,
		8, 0, 2, 1, 1,
		NULL,
		"ASPECT", "OrbitSize", NULL,
	},
	{
		"Orbit Timer Period (ms)", NUMBER, 0, &aspectSettings.timerOrbitMS,
		60000, 0, 2, 1, 1,
		NULL,
		"ASPECT", "OrbitTimerPeriod", NULL,
	},
	{
		"Auto-Size Window", ONOFF, 0, &aspectSettings.autoResizeWindow,
		FALSE, 0, 1, 1, 1,
		NULL,
