...
# ADD CPP /nologo /G6 /MT /W3 /Gi /Ot /Gf /Gy /I "..\driver\include\\" /I "..\api" /D "NDEBUG" /D "_WINDOWS" /D "WIN32" /D "_MBCS" /FAcs /YX"stdafx.h" /FD /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 ..\Driver\DLL\Release\dTVdrv.lib ddraw.lib dxguid.lib kernel32.lib user32.lib gdi32.lib advapi32.lib shell32.lib winmm.lib comdlg32.lib COMCTL32.LIB version.lib htmlhelp.lib /nologo /subsystem:windows /incremental:yes /map /machine:I386 /out:"..\Release\DScaler.exe"
